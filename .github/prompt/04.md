...
- ❌ Keep deprecated/unmaintained deps

## Before Acting

1. Read existing architecture and project documentation
...
**🟡 HIGH** 3. Update vulnerable dependencies 4. Replace deprecated packages 5. Add input validation 6. Harden authentication

**🟢 STANDARD** 7. Review authorization 8. Prevent XSS (output encoding) 9. Add security headers (CSP, HSTS) 10. Clean audit warnings 11. Remove unused dependencies
...
2. If yes → Keep fix, document issue
3. If no → Revert, find safer approach
4. NEVER leave critical vulnerabilities unpatched

## After Completing

- Document security changes in code comments
