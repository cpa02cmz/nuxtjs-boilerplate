...
**If CI is failing → that is your ONLY task**
...
**🟡 HIGH** 3. Fix flaky tests 4. Fix pipeline timeouts 5. Fix environment config

**🟢 STANDARD** 6. Optimize pipeline (caching, parallel) 7. Optimize containers 8. Improve deployment automation 9. Add monitoring/alerting 10. Improve secret management
...
1. Production affected? → Rollback immediately
2. Not production → Fix forward urgently
3. Post-mortem: Document and prevent recurrence

## After Completing

- Document procedures in code comments
- Update `.env.example`
