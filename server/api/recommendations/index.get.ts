...
export default defineEventHandler(async event => {
  try {
    ...
    try {
      ...
      const searchTrends = []
      const trendsDays = analyticsConfig.trends.defaultDays
      const minCount = analyticsConfig.trends.minRandomCount
      const maxCount = analyticsConfig.trends.maxRandomCount
