      ...
      paths: {
        '/api/v1/resources': {
          get: {
            ...
            tags: ['Resources'],
            // Flexy hates hardcoded rate limits! Using rateLimitConfig
            'x-rateLimit': {
              config: 'api',
              limit: rateLimitConfig.api.maxRequests,
              window: '1 min',
            },
            parameters: [
              {
        ...
        '/api/recommendations/index': {
          get: {
            ...
            description:
              'Get personalized or trending resource recommendations.',
        ...
        '/api/v1/categories': {
          get: {
            ...
            description:
              'Retrieve list of all categories with resource counts.',
        ...
        '/api/validate-url': {
          post: {
            ...
            'x-rateLimit': {
              config: 'standard',
              limit: rateLimitConfig.general.maxRequests,
              window: '15 min',
            },
            requestBody: {
              required: true,
            ...
            parameters: [
              {
                ...
                in: 'query',
                description:
                  'Start date for analytics export (ISO 8601 format)',
                required: false,
                schema: {
                  type: 'string',
                  format: 'date-time',
        ...
        '/api/submissions/index': {
          get: {
            ...
            description:
              'Retrieve list of submissions with optional filtering.',
            ...
            parameters: [
              {
                ...
                in: 'query',
                description:
                  'User ID (defaults to default-user if not provided)',
                required: false,
              ...
              parameters: [
                {
                  ...
                  required: true,
                  description:
                    'Comma-separated list of resource IDs to compare',
                  schema: {
                    type: 'array',
                    items: { type: 'string' },
                    minItems: 2,
