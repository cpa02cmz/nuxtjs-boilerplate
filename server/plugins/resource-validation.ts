...
import { TIME_CONSTANTS, SERVER_TIMING } from '~/utils/constants'
...
export default defineNitroPlugin(async nitroApp => {
  ...
  }, TIME_CONSTANTS.HOUR_MS) // 1 hour in milliseconds
  ...
  }, SERVER_TIMING.STARTUP_DELAY_MS) // delay to allow server to fully start
