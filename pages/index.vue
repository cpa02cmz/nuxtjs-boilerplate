...
// 🦇 BroCula: Lazy loading ResourceSort to reduce initial bundle size and improve performance
// This component is not critical for initial render and can be loaded asynchronously
...
const loadMoreWithEnhancedFeedback = async () => {
  ...
  // Haptic feedback for mobile users - BroCula fix: Use triggerHaptic to check user interaction
  if (hapticConfig.isEnabled('loadMore')) {
    triggerHaptic('light')
  }
