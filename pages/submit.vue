      ...
      <div class="bg-white shadow-xl rounded-lg p-6 sm:p-8">
        <form class="space-y-6" @submit.prevent="submitResource">
          ...
          <div class="pt-4">
            ...
            >
              <span v-if="!isSubmitting">Submit Resource for Review</span>
            ...
            <div class="ml-3">
              ...
              <div class="mt-2 text-sm text-green-700">
                <p>
                  ...
                  and approve it if it meets our quality standards. You can
                  track the status of your submission in your account.
                </p>
              </div>
            </div>
          </div>
...
// Import QualityChecks component
import QualityChecks from '~/components/QualityChecks.vue'
