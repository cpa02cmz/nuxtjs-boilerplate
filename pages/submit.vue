            ...
            <div class="mt-1 flex justify-between items-start">
              ...
              <span
                :class="[
                  ...
                  formData.title.length > maxTitleLength * 0.8
                    ? 'text-amber-600'
                    : 'text-gray-400',
                  formData.title.length >= maxTitleLength ? 'text-red-600' : '',
                ]"
                aria-live="polite"
                :aria-label="`${formData.title.length} of ${maxTitleLength} characters used`"
              >
          ...
          <div>
            ...
            <div class="mt-1 flex justify-between items-start">
              ...
              <span
                :class="[
                  'text-xs transition-colors duration-200 font-medium',
                  formData.description.length > maxDescriptionLength * 0.8
                    ? 'text-amber-600'
                    : 'text-gray-400',
                ...
                aria-live="polite"
                :aria-label="`${formData.description.length} of ${maxDescriptionLength} characters used`"
              >
                {{ formData.description.length }}/{{ maxDescriptionLength }}
              </span>
            </div>
