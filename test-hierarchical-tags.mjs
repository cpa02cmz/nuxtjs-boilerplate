...
const tagInterface = readFileSync('./types/tag.ts', 'utf8')
const resourceInterface = readFileSync('./types/resource.ts', 'utf8')
const useTagsComposable = readFileSync('./composables/useTags.ts', 'utf8')
const resourceFilters = readFileSync('./components/ResourceFilters.vue', 'utf8')
const useResourceFilters = readFileSync(
  './composables/useResourceFilters.ts',
  'utf8'
)
const searchApi = readFileSync('./server/api/v1/search.get.ts', 'utf8')
const resourcesApi = readFileSync('./server/api/v1/resources.get.ts', 'utf8')
const tagsApi = readFileSync('./server/api/v1/tags.get.ts', 'utf8')
