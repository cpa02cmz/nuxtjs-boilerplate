...
/* Breadcrumb link with slide-in underline animation - Flexy hates hardcoded values! */
.breadcrumb-link {
  position: relative;
  display: inline-flex;
  flex-direction: column;
  color: v-bind('componentColorsConfig.common.blue[600]');
...
.breadcrumb-link:hover {
  color: v-bind('componentColorsConfig.common.blue[800]');
}

.breadcrumb-link:focus-visible {
  outline: 2px solid v-bind('componentColorsConfig.common.blue[600]');
  outline-offset: 2px;
}
...
/* Slide-in underline effect - Palette's micro-UX delight! - Flexy hates hardcoded values! */
.breadcrumb-underline {
  ...
  background: linear-gradient(
    90deg,
    v-bind('componentColorsConfig.common.blue[600]'),
...
/* Separator styling - Flexy hates hardcoded values! */
.breadcrumb-separator {
  color: v-bind('componentColorsConfig.common.gray[600]');
  transition: color v-bind('`${animationConfig.transition.fast.durationMs}ms`')
    ease-out;
}

/* Current page styling with pulse indicator - Flexy hates hardcoded values! */
.breadcrumb-current {
  position: relative;
  display: inline-flex;
  align-items: center;
  gap: 0.5rem;
  color: v-bind('componentColorsConfig.common.gray[500]');
  font-weight: 500;
...
/* Pulsing indicator dot - Palette's micro-UX enhancement! - Flexy hates hardcoded values! */
.breadcrumb-current-indicator {
  width: 6px;
  height: 6px;
  background: v-bind('componentColorsConfig.common.blue[600]');
  border-radius: 50%;
  animation: pulse-dot
...
@keyframes pulse-dot {
  ...
  100% {
    transform: scale(1);
    opacity: 1;
    box-shadow: 0 0 0 0 v-bind('`rgba(37, 99, 235, 0.4)`');
  }
  50% {
    transform: scale(1.2);
    opacity: 0.8;
    box-shadow: 0 0 0 4px v-bind('`rgba(37, 99, 235, 0)`');
  }
}
