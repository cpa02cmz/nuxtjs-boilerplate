...
.category-checkmark {
  ...
  animation: checkmark-draw
    v-bind('animationConfig.userPreferenceManager.checkmarkDrawDurationSec')
    ease-out forwards;
}
...
.save-checkmark {
  ...
  animation: save-checkmark-draw
    v-bind('animationConfig.userPreferenceManager.saveCheckmarkDurationSec')
    ease-out
    v-bind('animationConfig.userPreferenceManager.saveCheckmarkDelaySec')
    forwards;
}
...
.save-success-text {
  animation: success-text-fade
    v-bind('animationConfig.userPreferenceManager.successFadeDurationSec')
    ease-out;
}
...
.animate-spin {
  animation: spin
    v-bind('animationConfig.userPreferenceManager.spinDurationSec') linear
    infinite;
}
