              ...
              <div class="w-full flex justify-center">
                <div
                  ...
                  :style="{
                    ...
                    animationDelay: `${index * animationConfig.searchAnalytics.barStaggerDelayMs}ms`,
                  }"
...
const onEnter = (el: Element, done: () => void) => {
  ...
  const delay = index * animationConfig.searchAnalytics.itemStaggerDelayMs
  ...
  setTimeout(() => {
    ...
    setTimeout(done, animationConfig.searchAnalytics.transitionDoneDelayMs)
  }, delay)
}
...
const getSearchItemStyle = (index: number) => {
  ...
  return {
    '--stagger-delay': `${index * animationConfig.searchAnalytics.barStaggerDelayMs}ms`,
  }
}
