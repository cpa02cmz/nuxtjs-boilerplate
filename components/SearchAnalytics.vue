      ...
      <div class="bg-gray-50 p-6 rounded-lg border border-gray-200">
        ...
        <ul v-else class="space-y-2 max-h-64 overflow-y-auto">
          <li
            ...
            :key="query.query"
            class="flex items-center justify-between p-2 hover:bg-gray-100 rounded transition-colors duration-150" <!-- Flexy hates hardcoded transitions without duration! Added duration-150 -->
          >
            <div class="flex items-center">
