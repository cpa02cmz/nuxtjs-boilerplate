  ...
  >
    <div class="p-4">
      ...
      <div class="mt-3 flex flex-wrap gap-1">
        ...
        >
          +{{ resource.tags.length - maxTagsDisplay }} more
        </span>
      </div>
...
const maxTagsDisplay = uiConfig.displayLimits.recommendations.maxTagsDisplay

const displayTags = computed(() => {
  if (!props.resource?.tags) return []
  return props.resource.tags.slice(0, maxTagsDisplay)
})

const hasMoreTags = computed(() => {
  return (props.resource?.tags?.length || 0) > maxTagsDisplay
})
</script>
