...
.completion-content {
  ...
  animation: completion-pop-in
    v-bind('animationConfig.readingProgress.completionPopInDurationSec + "s"')
...
.checkmark-svg {
  ...
  animation: icon-rotate-in
    v-bind('animationConfig.readingProgress.iconRotateDurationSec + "s"')
    ease-out v-bind('animationConfig.readingProgress.iconRotateDelaySec + "s"')
    both;
}
...
.checkmark-circle {
  ...
  animation: circle-scale
    v-bind('animationConfig.readingProgress.circleScaleDurationSec + "s"')
    ease-out v-bind('animationConfig.readingProgress.circleScaleDelaySec + "s"')
    both;
}
...
.reading-time-content {
  ...
  animation: reading-time-pop
    v-bind('animationConfig.readingProgress.readingTimePopDurationSec + "s"')
...
.reading-time-icon {
  ...
  animation: clock-tick
    v-bind('animationConfig.readingProgress.clockTickDurationSec + "s"')
    ease-in-out infinite;
}
...
.reading-time-complete {
  ...
  animation: complete-pulse
    v-bind('animationConfig.readingProgress.completePulseDurationSec + "s"')
    ease-in-out infinite;
}
