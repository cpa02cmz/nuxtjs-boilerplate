...
interface PressAndHoldReturn {
  state: { isPressing: boolean; progress: number; isComplete: boolean }
  progressStyle: {
    '--progress-offset': string
    '--circumference': string
    '--ring-size': string
    '--stroke-width': string
    '--ring-color': string
    '--ring-bg-color': string
    '--duration': string
  }
  startPress: () => void
  endPress: () => void
...
const pressAndHoldStates = ref<Map<string, PressAndHoldReturn>>(new Map())
