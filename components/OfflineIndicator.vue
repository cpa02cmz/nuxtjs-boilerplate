...
.animate-pulse-subtle {
  animation: pulse-subtle
    v-bind('animationConfig.offlineIndicator.subtlePulseDurationSec')
...
.animate-icon-pulse {
  animation: icon-pulse
    v-bind('animationConfig.offlineIndicator.iconPulseDurationSec') ease-in-out
    infinite;
}
...
.animate-check-pop {
  animation: check-pop
    v-bind('animationConfig.offlineIndicator.checkPopDurationSec')
    v-bind(
...
/* Spinner animation */
.animate-spin {
  animation: spin v-bind('animationConfig.offlineIndicator.spinDurationSec')
    linear infinite;
}
