...
.skeleton-shimmer {
  ...
  animation: shimmer v-bind('animationConfig.filterSidebar.shimmerDurationSec')
...
.skeleton-filter-sidebar {
  animation: fadeIn v-bind('animationConfig.filterSidebar.fadeInDurationSec')
    ease-out;
}
...
@media (prefers-reduced-motion: reduce) {
  ...
  .skeleton-filter-sidebar {
    animation: fadeIn
      v-bind('animationConfig.filterSidebar.reducedFadeInDurationSec') ease-out;
  }
