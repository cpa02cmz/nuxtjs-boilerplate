<template>
  <div class="bg-white p-6 rounded-lg shadow border border-gray-200">
    <div class="flex justify-between items-center mb-4">
      ...
      <button
        :class="[
          `text-sm transition-all ${tailwindClassesConfig.duration.normal} ${tailwindClassesConfig.easing.easeOut} focus:outline-none focus:ring-2 focus:ring-gray-800 focus:rounded px-2 py-1 rounded`,
          resetConfirming
