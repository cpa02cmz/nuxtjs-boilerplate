    ...
    >
      <span
        ...
        :class="[
          ...
          healthClass,
          {
            'health-indicator--celebrating': isCelebrating && !prefersReducedMotion,
...
const isExcellentHealth = computed(() => {
  return props.healthScore !== undefined && 
...
.health-indicator--excellent::before {
  ...
  animation: health-ring-pulse
    v-bind('`${animationConfig.resourceStatus.healthRingDurationSec}s`') ease-out
    infinite;
}
